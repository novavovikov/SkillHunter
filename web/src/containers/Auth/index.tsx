          ...
          <div className={s.Auth__faqRow}>
            <div className={s.Auth__faqCol}>
              <Faq title={'Я могу создать аккаунт с помощью email и пароля?'}>
                <>
                  <p>
                    Нет. Мы поддерживаем регистрацию и вход только через Google или Facebook, потому что мы считаем что,
                    это
                    наилучший способ обеспечения безопасности ваших данных.
                  </p>
                  <p>
                    Использование email и паролей может показаться простым на первый взгляд, но здесь много сложностей:
                    восстановление паролей, двухфакторная аутентификация, обнаружение мошенничества, обнаружение атаки
                    методом
                    перебора и надежное хранение хешированных и паролей с секретом. Мы считаем, что предоставление этих
                    задач
              ...
              <Faq title={'Вы сможете читать мои сообщения и письма или получите доступ к личной информации?'}>
                <>
                  <p>
                    Нет, не сможем. И нам это не нужено. Мы просто запрашиваем основную информацию вашего профиля. У нас
                    не
              ...
              ' Google, или наоборот?'}>
                <>
                  ...
                  <p>
                    ...
                    вашей учетной записи Facebook, то чтобы использовать их для входа в одну учетную запись SkillHunter
