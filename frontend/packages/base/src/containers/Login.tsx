  ...
  return (
    <Container>
      <View style={[s.aic, s.pv5]}>
        ...
        <LoginButton system={System.google}>GOOGLE</LoginButton>
        <Text style={[s.lightGray, s.mv2]}>или</Text>
        <LoginButton system={System.facebook}>FACEBOOK</LoginButton>
        ...
        >
          Регистрируясь, вы соглашаетесь с нашими Terms of Service и Privacy Policy.
        </Text>

        <Text style={[s.aic, s.jcc, s.silver]}>
          <Image
        ...
        <View style={[s.aic, s.mt6]}>
          ...
          <Text style={[s.midGray, s.tc]}>
            Нет проблем!!! Вы можете создать аккаунт Google или Facebook с помощью вашего email.{' '}
